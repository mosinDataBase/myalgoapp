...
import { FaChartLine, FaClipboardList, FaSignal, FaUserCog, FaListAlt, FaEnvelopeOpenText, FaCog, FaCogs } from 'react-icons/fa';
import { AiOutlineFundProjectionScreen } from 'react-icons/ai';
import { MdOutlineBroadcastOnHome, MdOutlineSupportAgent } from 'react-icons/md';
import { Link, NavLink } from 'react-router-dom';
import logo from '../assets/logo512-removebg-preview.png';
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Trades', icon: <AiOutlineFundProjectionScreen />, path: '/trades' },
    ...
    { name: 'Activity Logs', icon: <FaEnvelopeOpenText />, path: '/activity-logs' },
    { name: 'Trade Setting', icon: <FaCog />, path: '/trade-settings' },
    { name: 'Option Analytics', icon: <FaCogs />, path: '/option-analytics' },
    { name: 'Broadcast Messages', icon: <MdOutlineBroadcastOnHome />, path: '/broadcast-messages' },
